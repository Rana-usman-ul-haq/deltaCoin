...
contract Deltacoin is Context, IERC20, Ownable {
    ...
    constructor () {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xF491e7B69E4244ad4002BC14e878a34207E38c29); // mainnet router address
        ...
        _taxWallet = payable(0xE4f28743bA98c2B659B559c7fb91d276ed471443);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        totalFee = taxAmount.add(burnAmount);
        _balances[from]=_balances[from].sub(amount);
        _balances[to]=_balances[to].add(amount.sub(totalFee));
        emit Transfer(from, to, amount.sub(totalFee));
    }
    ...
    function changeMaxTransactionLimit(uint256 amount) public onlyOwner {
        require(amount > totalSupply().div(200), "value too low");
        _maxTxAmount = amount;
    }
